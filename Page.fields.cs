    ...
    public partial class Page
    {
        ...
        internal class FieldActualInfo : IDisposable
        {
            ...
            List<string> getOcrTextLines()
            {
                ...
                if (ActualField.ColumnOfTable == null)
                {
                    if (((Template.Field.Ocr)ActualField).GetOcrMode(page.PageCollection.ActiveTemplate).HasFlag(Template.Field.OcrModes.SingleFieldFromFieldImage))
                    {
                ...
                List<string> ls = new List<string>();
                if (((Template.Field.Ocr)ActualField).GetOcrMode(page.PageCollection.ActiveTemplate).HasFlag(Template.Field.OcrModes.ColumnFieldFromFieldImage))
                {
