...
- ?migrate to iText7 (!!! it has the following bugs: -some pdf's are read in wrong encoding; -wrong and sometimes very wrong GetAscentLine(); -new PdfReader(file) locks file forever if read error;)
