...
//        //!!!exported from UnsafeNativeMethods.cs where it had another SECURITY_ATTRIBUTES definition
//        //[DllImport("kernel32.dll", SetLastError = true, BestFitMapping = false, CharSet = CharSet.Auto)]
//        //public static extern SafePipeHandle CreateNamedPipe(string pipeName, uint openMode, int pipeMode, int maxInstances, int outBufferSize, int inBufferSize, int defaultTimeout, SECURITY_ATTRIBUTES securityAttributes);
...
//        [DllImport("shell32.dll", CharSet=System.Runtime.InteropServices.CharSet.Auto, SetLastError=true)]
//        [ResourceExposure(ResourceScope.Machine)]
//        public static extern bool ShellExecuteEx(ShellExecuteInfo info);
//        [DllImport("ntdll.dll", CharSet=System.Runtime.InteropServices.CharSet.Auto)]
//        [ResourceExposure(ResourceScope.Machine)]
...
//        [ResourceExposure(ResourceScope.Machine)]
//        public static extern SafeFileHandle CreateFile(string lpFileName,uint dwDesiredAccess,uint dwShareMode, SECURITY_ATTRIBUTES lpSecurityAttributes, uint dwCreationDisposition,uint dwFlagsAndAttributes, SafeFileHandle hTemplateFile);
//        [DllImport("ntdll.dll")]
...
//            IntPtr ReturnLength
//        );
//        [DllImport("user32.dll", CharSet=System.Runtime.InteropServices.CharSet.Auto, BestFitMapping=true)]
//        [ResourceExposure(ResourceScope.None)]
