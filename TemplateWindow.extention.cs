    ...
    public partial class TemplateWindow
    {
        ...
        void setUIFromTemplate(Template t)
        {
            try
            {
                ...
                autoDeskew.IsChecked = t.AutoDeskew;
        ...
        private void ShowPdfText_LinkClicked(object sender, RoutedEventArgs e)
        {
            if (pages == null)
                return;
        ...
        private void ShowOcrText_LinkClicked(object sender, RoutedEventArgs e)
        {
            if (pages == null)
                return;
        ...
        private void showAsJson_LinkClicked(object sender, RoutedEventArgs e)
        {
        ...
        Template getTemplateFromUI(bool saving)
        {
            ...
            t.AutoDeskew = autoDeskew.IsChecked == true;
